	...
	<body>
		<div id="wrap">
			...
			<?php
				...
				// 比對其帳號與密碼
				$sql = "SELECT * FROM iot_user WHERE account = '".mysql_real_escape_string($userAcc)."' AND password = '".mysql_real_escape_string($userPwd)."' ";
				...
				if ($row != null && $userAcc != null && $userPwd != null) {
					...
					echo("</center>");
					echo("<p></p>");
					echo('<input type ="button" onclick="location.href='."'index.php'".'" value="Back"></input>');
					exit;
				}
			?>
		</div>
